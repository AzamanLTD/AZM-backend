...
const PERMISSION_KEYS = {
  ...
  marketing: [
    ...
    { key: 'storefront.manage',      label: 'Manage storefront',         module: 'Marketing' },
  ],
  notifications: [
...
const ROLE_TEMPLATES = {
  ...
  GENERAL_MANAGER: {
    ...
    permissions: [
      ...
      'reviews.view', 'reviews.respond', 'showcase.manage', 'followers.broadcast', 'storefront.manage',
  ...
  BRANCH_MANAGER: {
    ...
    permissions: [
      ...
      'finance.view',
      'marketing.view', 'reviews.view', 'reviews.respond', 'storefront.manage',
      'notifications.view', 'analytics.view',
    ],
    system: true,
  },
  ...
  MARKETER: {
    ...
    permissions: [
      ...
      'showcase.manage', 'followers.broadcast', 'storefront.manage',
      'notifications.view',
    ],
    system: true,
  },
