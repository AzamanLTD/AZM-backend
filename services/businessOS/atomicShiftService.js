 ...
 *
 * ShiftService contains the established read/query contract. These overrides
 * add conditional state transitions so concurrent requests cannot apply the
 * same attendance or swap mutation twice.
 */
