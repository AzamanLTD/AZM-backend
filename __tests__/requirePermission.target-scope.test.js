...
describe('requirePermission target business scoping', () => {
    function makeReq({ key, id = 'target', businessProfileId = 'business-a', userRole = 'BUSINESS' }) {
        const prisma = {
        ...
        return { req: { user: { id: 1, role: userRole }, params: { id }, businessProfileId, app: { get: jest.fn().mockReturnValue(prisma) } }, prisma, middleware: requirePermission(key) };
    }
